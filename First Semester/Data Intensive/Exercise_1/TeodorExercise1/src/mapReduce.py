...
class MapReducer(MRJob):
	...
	# Putting all generated tuples in one list. And creating two dicts, one for each word and all occurrences and one for each category
        ...
        for i in range(0,count):
			...
			# appending all the words existing in the output.txt file in one list (no dublications)
